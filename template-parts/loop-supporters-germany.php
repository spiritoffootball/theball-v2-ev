<?php
/**
 * Template part for embedding a display of all Supporters with the tag "Deutschland".
 *
	...
	<section id="organisations-partners-germany" class="loop-include loop-include-four content-area clear">
		<div class="loop-include-inner">
			...
			<header class="loop-include-header">
				<h2 class="loop-include-title"><?php esc_html_e( 'Supporters in Germany', 'the-ball-v2-ev' ); ?></h2>
