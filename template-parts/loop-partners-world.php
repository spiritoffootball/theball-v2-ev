<?php
/**
 * Template part for embedding a display of all Partners with the tag "Welt".
 *
	...
	<section id="organisations-partners-world" class="loop-include loop-include-four content-area clear">
		<div class="loop-include-inner">
			...
			<header class="loop-include-header">
				<h2 class="loop-include-title"><?php esc_html_e( 'Worldwide Network Partners', 'theball-v2-ev' ); ?></h2>
