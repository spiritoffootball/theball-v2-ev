<?php
/**
 * Template part for embedding a display of all Partners with the tag "Erfurt".
 *
...
if ( $loop_include->have_posts() ) : ?>
	...
	<!-- loop-partners-erfurt.php -->
	<section id="organisations-partners-erfurt" class="loop-include loop-include-four content-area clear">
		<div class="loop-include-inner">

			<header class="loop-include-header">
				<h2 class="loop-include-title"><?php esc_html_e( 'Network Partners in Erfurt', 'the-ball-v2-ev' ); ?></h2>
