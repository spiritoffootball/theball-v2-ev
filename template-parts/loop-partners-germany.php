<?php
/**
 * Template part for embedding a display of all Partners with the tag "Deutschland".
 *
...
if ( $loop_include->have_posts() ) : ?>
	...
	<!-- loop-partners-germany.php -->
	<section id="organisations-partners-germany" class="loop-include loop-include-four content-area clear">
		<div class="loop-include-inner">

			<header class="loop-include-header">
				<h2 class="loop-include-title"><?php esc_html_e( 'Network Partners in Germany', 'the-ball-v2-ev' ); ?></h2>
